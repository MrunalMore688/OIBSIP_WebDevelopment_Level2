...
Designed the layout with HTML, including buttons and a display screen.

Applied CSS styling to give a modern, clean, and responsive interface.

Wrote JavaScript logic for:

Capturing number inputs
...
Implemented validations to handle invalid inputs or expressions.

Tested the application across multiple scenarios to ensure accuracy.
